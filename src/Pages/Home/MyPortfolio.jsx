  ...
  return (
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <Link to="/europa" className="btn btn-github">
            <svg
          ...
          <Link to="/asien" className="btn btn-github">
            {/* Icon für Asien (ersetze dies durch das entsprechende Symbol oder Text) */}
            Visit Asien
          </Link>
          <Link to="/amerika" className="btn btn-github">
            {/* Icon für Amerika (ersetze dies durch das entsprechende Symbol oder Text) */}
            Visit Amerika
          </Link>
        </div>
      </div>
